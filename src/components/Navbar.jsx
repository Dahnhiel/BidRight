      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 bg-[#1E3A8A] hover:bg-[#2563EB] text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors"
          >
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 pb-4 pt-2 shadow-lg">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 flex items-center justify-center gap-2 bg-[#1E3A8A] text-white text-sm font-semibold px-4 py-2.5 rounded-lg"
          >
            <WhatsAppIcon className="w-4 h-4" />
            WhatsApp Us
          </a>
